    ...
    <body>
        ...
        <form class="formulaire" action="index.php" method="post">
            ...
            <div class="form-group">
                ...
                <textarea class="objet" id="content" rows="4" placeholder="Entrez le contenu de la newsletter" name="content" required></textarea>
            </div>
        ...
        <div class="container">
            <table class="table table-bordered table-dark">
                <h1> <?php echo $_SESSION['prenom'] ?> voici la liste des newsletters</h1>
                ...
                <tr>
                    <td> <?php echo $newsl->id ?> </td>
                    <td> <?php echo $newsl->nom ?> </td>
                    <td> <?php echo $newsl->content ?> </td>
                    <td> <?php echo $newsl->created_at ?> </td>
                    <td> <?php if ($newsl->is_sent == 0) {
                        echo "Non";
                    } else {
                        echo "Oui";} ?> </td>
                    <td>
