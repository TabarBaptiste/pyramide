<html>
    <head>
        <link rel="stylesheet" type="text/css" href="assets/css/0propos_nous.css">
        <link href="https://fonts.cdnfonts.com/css/gotham" rel="stylesheet">
        <style>
            @import url('https://fonts.cdnfonts.com/css/gotham');
        </style>
        <?php //require_once 'header_propos.php'; ?>
    </head>
    ...
    <a href="index.php#about">
        ...
        <div class="write">
            ...
            <table class="trois">
                <tr>
                    <th>
                    <div class="gauche">
                        <!-- <img src="" alt="carré rouge"> -->
                        <p>Notre volonté première est d'améliorer
                            la qualité de vie ainsi que l'environnement
                    ...
                    <th class="tab">
                        <div class="milieu">
                            <!-- <img src="" alt="rond bleu"> -->
                            <p>Dans un second temps, nous voudrions participer à la sensibilisation et la responsabilisation ambiante qui
                                porte sur l'écologie.
                            </p>
                        </div>
                    </th> 
                    <th>
        ...
        <div class="reseau">
            ...
            <table align="center">                
                ...
                <th class="pp">
                    <p>Linked<f>In</f></p>
                    <iframe src="https://www.linkedin.com/embed/feed/update/urn:li:share:7010191048899481600" height="439" width="504" frameborder="0" allowfullscreen="" title="Post intégré"></iframe>
                </th>
            </table>
