          ...
          <div class="row grid">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all gra">
              ...
              <form action="inscrit_events.php" method="post">
                ...
                <input class="inscrip" type="submit" value="S'inscrire à l'événement Futsal" onclick="return confirm('Êtes-vous sûr de vouloir vous inscrire à cet évenements');">
              </form>
                <!-- Fin -->
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all dev">
              ...
              <form action="inscrit_events.php" method="post">
                ...
                <input class="inscrip" type="submit" value="S'inscrire à l'événement ramassage" onclick="return confirm('Êtes-vous sûr de vouloir vous inscrire à cet évenements');">
              </form>
            </div>
