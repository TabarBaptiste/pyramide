...
<body>
    <div class="container">
        <table class="table table-bordered table-dark">
            <h1>
                <?php echo $_SESSION['prenom'] ?> voici la liste des événements auxquels vous êtes inscrit
            </h1>
            ...
            <?php foreach ($userEvents as $event): ?>
                <tr>
                    ...
                    <td><a href="desinscriptionEvent.php?event_id=<?php echo $event->id ?>"
                            onclick="return confirm('Êtes-vous sûr de vouloir vous désinscrire ?');">Se désinscrire</a>
                    </td>
                </tr>
            <?php endforeach ?>
        </table>
