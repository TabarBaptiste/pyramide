                                    ...
                                    <div class="col-md-8 col-sm-12">
                                      ...
                                      <label for="email" class="sr-only">Adresse email</label>
                                        <input value='<?php if (isset($_SESSION['id'])) {
                                            echo $user->email;
                                        }?>' name="email" type="text" id="email" placeholder="Entrer votre email..." required>
                                      </fieldset>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                      <fieldset>
                                        <button type="submit" name="subscribe" id="form-submit" class="main-button">S'abonner</button>
                                    </fieldset>
                                </div>
                            </div>
                        </form>
