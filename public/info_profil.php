...
<body>
    <div class="card">
        ...
        <ul>
            ...
            <li>Nombre d'événements inscrits :
                <?php echo $user['nb_events']; ?>
            </li>
            <?php
            if (($user)['nb_events'] > 0) {
        ...
        <a href="delete_profil.php?delete=<?php echo $user['id'] ?>"
            onClick="return(confirm('Êtes-vous sûr de vouloir supprimer votre compte ?'));"><button class="supp-button"
                type="button">Supprimer mon compte</button></a>
        </form>
