            ...
            <form action="index.php" method="post">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="nom" class="form-control" id="nom" placeholder="Votre Nom" name="nom" autocomplete="on"
          ...
          <div class="card-body-bottom">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="password" class="form-control" id="password" pattern="(?=.*\d)(?=.*[A-Z])[A-Za-z\d]{8,}"
                  title="Le mot de passe doit contenir au moins 8 caractères, au moins 1 chiffre et au moins 1 caractère majuscule."
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="password" class="form-control" id="password_confirm"
                  placeholder="Confirmez votre mot de passe" name="password_confirm" required>
              </div>
            </div>
            <!-- Scirpt -->
            <script>
            ...
            <!-- Ajout -->
            <input type="submit" value="Créer" class="btn float-center login_btn" name="ajout" id="submit">
            </form>
          </div>
        </div>
      </div>
