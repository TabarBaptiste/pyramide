            ...
            <form action="index.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="nom" class="form-control" id="nom" placeholder="Votre Nom" name="nom" autocomplete="on" required oninput="this.value = this.value.toUpperCase();">
                  </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="prenom" class="form-control" id="prenom" placeholder="Votre Prénom" name="prenom" autocomplete="on" required oninput="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1);">
                </div>
